...
def gfx90a_fp4_expert_gate_up_grouped(
    ...
    if use_row_prefetch:
        assert e == 256 and m in (32, 51, 64, 96, 128, 192)
        ...
        tp8_m192 = (m, topk, i, k, blocks) == (192, 6, 256, 4096, 832)
        assert tp8_m32 or tp8_m96 or tp8_m128 or tp8_m192 or (topk, i, k) == (6, 512, 4096)
        assert (assignments, rows, waves, weight_mode) == (4, 2, 8, 2)
        assert (
            tp8_m32 or tp8_m96 or tp8_m128 or tp8_m192 or (m == 51 and blocks == 1664)
...
def gfx90a_fp4_expert_down_grouped(
    ...
    *,
    ...
    if use_row_prefetch:
        ...
        tp8_m192 = (m, topk, n, k) == (192, 6, 4096, 256)
        assert tp8_m96 or tp8_m128 or tp8_m192 or (topk, n, k) == (6, 4096, 512)
        ...
        module_loader = (
            ...
            if tp8_m96 or tp8_m128 or tp8_m192
