"""Default-off fixed-order TP8 large-prefill wq_b numerical diagnostic."""
import logging
...
def project(x, weight):
    ...
    if (x.ndim != 2 or weight.shape != (4096, 1024)
        ...
        raise ValueError("Stable wq_b requires BF16 M8192..36864/K1024/N4096 on one GPU")
    ...
    if not _logged:
        logging.getLogger(__name__).info(
            "DSV4 diagnostic stable wq_b selected: M=%d K1024 N4096 tile128/128/128 waves8",
            x.shape[0])
        _logged = True
    return y
