...
class OwnerK32(unittest.TestCase):
    ...
    def test_supported_geometry(self):
        for local,width,m in [(3072,2048,32768),(3584,4096,32768),(3840,8192,32767),(4096,8191,32768),(1024,2048,8192)]:
            ...
            self.assertTrue(self.admitted(local,width,m,preshuffle_tile=16))
    ...
    def test_fallback(self):
        ...
        for shuffle,fp16,fnuz in [(8,False,False),(32,False,False),(0,True,False),(0,False,True)]:
    ...
    def test_fixed_launch_contract(self):
        ...
        self.assertEqual([ast.unparse(x) for x in launch.args[-6:]],['16','32','preshuffle_tile','tl.bfloat16','tl.float8e4nv','1'])
