...
def main():
    ...
    p.add_argument('--request-count', type=int, choices=(16, 32, 64), default=16)
    p.add_argument('--prefill-tokens', type=int, choices=(16384,32768), required=True)
    args = p.parse_args()
    ...
    for phase, target in [('decode', 512), ('prefill', args.prefill_tokens)]:
