...
for arm in ('A1','B','A2'):
    ...
    assert json.loads((directory/f'P16-mix4-{arm}.stop.json').read_text())['remaining']==[]
...
component=root
for name in ('screen.json','screen.log','full.json','full.log','runtime.json','runtime.log'):
