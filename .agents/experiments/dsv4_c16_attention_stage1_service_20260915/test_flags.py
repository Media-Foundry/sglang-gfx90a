...
def test_only_pipeline_changes():
    ...
    assert {key for key in a if a[key]!=b[key]}=={'SGLANG_DSV4_PREFILL_ATTN_STAGE1'}
    for key in ('SGLANG_DSV4_C4_PREFILL_QUERY_PRODUCER',
                'SGLANG_DSV4_DEBUG_OWNER_PRODUCER_CHECK',
                'SGLANG_DSV4_DEBUG_PREFILL_OWNER_CHECK',
                'SGLANG_DSV4_DEBUG_PREFILL_ATTN_STAGE1_CHECK'):
