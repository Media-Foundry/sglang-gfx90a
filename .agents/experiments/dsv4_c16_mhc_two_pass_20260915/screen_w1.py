"""One-wave candidate; post+premix whole boundary screen; repeated real samples, not E2E."""
import argparse
import hashlib
import json
import os
...
for m in (17,128,8192,32768):
    ...
    resources=[]
    def candidate():
        kernel=post_project[(m,4)](x,residual,post,comb,fn,b,sb,partial,num_warps=1)
