"""Archive completed wo_b drift evidence, excluding checkpoint/activation data."""
import hashlib
import json
...
target=root/'wob-evidence.tar.gz';manifest=root/'wob-evidence-manifest.json'
...
files += [manifest]+[root/name for name in (
    'wob-oracle.json','wob-oracle.log','wob-service-oracle.json','wob-service-oracle.log',
    'wob-ties.json')]
