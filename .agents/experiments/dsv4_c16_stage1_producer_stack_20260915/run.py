"""Owner-Q producer ABBA on accepted stages1 attention; original C16 fixture."""
import argparse
import hashlib
...
stage_gate=json.loads((root.parent/'dsv4_c16_attention_stage1_service_20260915/acceptance.json').read_text())
assert stage_gate['status']=='accepted_scoped_profile' and stage_gate['candidate']>8300
...
label='P16-stage1-stack-'+args.arm
