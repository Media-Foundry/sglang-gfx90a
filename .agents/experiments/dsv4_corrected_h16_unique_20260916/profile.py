"""Non-scoring full-stage profile of the corrected, repeatable H16 checkpoint."""
import hashlib
...
state=life.start('P16-markers-corrected',0)
try:
    life.ready(state)
    info=json.loads((out/'P16-markers-corrected.server-info.json').read_text())
