"""Validate owner K32 against current K16 and the prior accepted common-MHC checkpoint."""
import hashlib
import json
import math
...
for arm in ('A1','B','A2'):
    ...
    log=(directory/f'P32-owner-k32-{arm}.service.log').read_text()
...
teacher_checks=[]
legacy=root.parent/'dsv4_prefill_mhc_common_20260916/B/teacher-forced.json'
...
summary=dict(timing_paths=paths,status='complete',scope='Original V4 TP8 C16x32K owner K16 vs K32, common FP32/20 MHC, original weights/native AR/1M KV',
