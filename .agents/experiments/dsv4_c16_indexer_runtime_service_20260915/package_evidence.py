...
for arm in ('A1','B','A2'):
    ...
    assert json.loads((directory/f'P16-qrunm-{arm}.stop.json').read_text())['remaining']==[]
...
for name in ('screen.json','screen.log','full.json','full.log','cache-proof.json','cache-proof.log',
             'integrated.json','integrated.log'):
    files.append((root.parent/'dsv4_c16_indexer_runtime_m_20260915'/name,'component/'+name))
