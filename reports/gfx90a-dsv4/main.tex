...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}p{0.29\textwidth}Y@{}}
    ...
    Hardware & Four visible MI250 GCDs (gfx90a), approximately 64 GiB HBM per GCD \\
...
The deployment uses AMD Instinct MI250 gfx90a GCDs. The software environment is fixed to PyTorch \texttt{2.12.0a0+git78258b9} and HIP/ROCm \texttt{7.14.60850}, with local SGLang and AIter source trees. The model at \texttt{/home/pc/models/modelscope} consists of 48 indexed safetensors shards. Residual \texttt{.incomplete} files are not referenced by the index and are not loaded.
