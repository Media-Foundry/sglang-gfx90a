...
def main():
    ...
    stem=a.dump_dir/'layer_0_rank_0_'
    ...
    for name in ('attn_residual','attn_pre_norm','attn_norm','q','attn_core','attn_inverse_rope','wo_a','wo_b_partial','wo_b','attn_out','attn_hc_post','ffn_norm','ffn_out','ffn_hc_post'):
