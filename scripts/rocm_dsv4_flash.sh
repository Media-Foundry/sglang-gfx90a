...
if [[ "${GFX90A_DSPARK_TP8_FULL_TARGET_PROFILE}" == "1" ]]; then
  ...
  export SGLANG_DSV4_GFX90A_DSPARK_TP8_M128_CK_SPARSE_DECODE="${SGLANG_DSV4_GFX90A_DSPARK_TP8_M128_CK_SPARSE_DECODE:-1}"
  ...
  export SGLANG_DSPARK_SYNC_DRAFT_ACROSS_TP="${SGLANG_DSPARK_SYNC_DRAFT_ACROSS_TP:-1}"
fi
...
export SGLANG_DSV4_GFX90A_QUEUE_AWARE_PREFILL_CHUNK="${SGLANG_DSV4_GFX90A_QUEUE_AWARE_PREFILL_CHUNK:-0}"
export SGLANG_DSV4_GFX90A_PREFILL_CHUNK_BASE="${SGLANG_DSV4_GFX90A_PREFILL_CHUNK_BASE:-2304}"
export SGLANG_DSV4_GFX90A_PREFILL_CHUNK_QUEUE_MIN="${SGLANG_DSV4_GFX90A_PREFILL_CHUNK_QUEUE_MIN:-2}"
