...
# A4 grouped loses to expert-owned projection through M64 on EP4 because most
# runs remain short; reserve it for larger uncaptured/eager tiers.
export SGLANG_QWEN4_GFX90A_MQ4G128_GROUPED_MIN_TOKENS=${SGLANG_QWEN4_GFX90A_MQ4G128_GROUPED_MIN_TOKENS:-128}
